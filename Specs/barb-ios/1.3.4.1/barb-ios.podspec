Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "6.0"
  s.source       = { :git => "https://github.com/bbc/barb-clients.git", :branch => "master" }
  s.source_files  = "ios/spring-appstreaming-iOS-barb-1.3.4.1/headers/SpringStreams.h"
  s.vendored_libraries = "ios/spring-appstreaming-iOS-barb-1.3.4.1/libSpring.a"
end
